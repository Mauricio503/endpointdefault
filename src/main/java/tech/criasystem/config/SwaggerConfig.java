...
public class SwaggerConfig {
	...
	private Info apiInfo() {
		return new Info().title("End Point Default").description("DEMO API").version("v1")
				.license(new License().name("Apache 2.0").url("http://springdoc.org"))
				.contact(new Contact().name("Maurício Spagnol").url("https:criasystem.tech")
						.email("mauriciogspagnol@gmail.com"));
	}
